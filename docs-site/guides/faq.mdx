...
See [User Guide — Customizing SOUL.md](/guides/user-guide#customizing-soulmd) for examples.
...
See [Security Guide](/guides/security) for details.
...
**Yes!** See [Developer Guide — Adding Tools](/guides/development#adding-custom-tools)
...
See [Developer Guide — Creating Skills](/guides/development#creating-skills)
...
**Yes!** See [Deployment Guide — Docker](/guides/deployment#docker-deployment)
...
See [Architecture — Scalability](/concepts/architecture-deep-dive#scalability-considerations) (or [Architecture](/concepts/architecture) for overview).

---

## Still Have Questions?

- 📖 **Browse the docs**: [Introduction](/introduction), [Quick Start](/quickstart), [User Guide](/guides/user-guide), [FAQ](/guides/faq)
- 💬 **Join Discord**: [discord.gg/overseer](https://discord.gg/overseer)
- 🐛 **Report issues**: [GitHub Issues](https://github.com/Quad-Labs-LLC/overseer/issues)
